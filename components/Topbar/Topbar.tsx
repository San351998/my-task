    ...
    <>
      <div className="w-full flex items-center justify-between px-4 h-[64px] border-b border-[#e7e9ec] bg-white relative">
        <div className="block lg:hidden">
          <Image
            src="/images/topbar/phone-menu.svg"
            alt="Menu"
            width={16}
            height={16}
        ...
        <div className="hidden sm:flex bg-white border border-[#e7e9ec] items-center rounded-[12px] px-3 h-[38px] md:w-[320px] lg:w-[528px]">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden w-full bg-white border-t border-[#e7e9ec] px-4 py-4 space-y-4">
          <div className="flex items-center border border-[#e7e9ec] rounded-[12px] px-3 h-[38px]">
            <Image src="/images/topbar/search.svg" alt="Search" width={16} height={16} />
            <input
              type="text"
              placeholder="Search"
